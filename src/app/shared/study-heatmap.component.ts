...
@Component({
        ...
        <ion-card class="heatmap-card">
            ...
            @if (!isCollapsed) {
                <ion-card-content class="heatmap-content">
                    ...
                    <div class="legend">
                        <span class="legend-hint">{{ emptyHint }}</span>
    ...
    styles: [`
        ...
        .cell[data-level="1"] { background: var(--heat-level-1); }
        .cell[data-level="2"] { background: var(--heat-level-2); }
        .cell[data-level="3"] { background: var(--heat-level-3); }
        .cell[data-level="4"] { background: var(--heat-level-4); }
        ...
        .calendar, .legend {
            --heat-level-0: rgba(var(--ion-color-medium-rgb), 0.14);
            --heat-level-1: #9be9a8;
            --heat-level-2: #40c463;
            --heat-level-3: #30a14e;
            --heat-level-4: #216e39;
        ...
        @media (prefers-color-scheme: dark) {
            .calendar, .legend {
                --heat-level-0: rgba(var(--ion-color-medium-rgb), 0.22);
                --heat-level-1: #0e4429;
                --heat-level-2: #006d32;
                --heat-level-3: #26a641;
                --heat-level-4: #39d353;
